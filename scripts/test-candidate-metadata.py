...
VERSION = "26.9.4"
COORDS = [
    ("org.pipelineframework", "pipeline-blocks", "pom"),
    ("org.pipelineframework.blocks", "document-text-extraction", "jar"),
    ("org.pipelineframework.blocks", "graphql", "jar"),
    ("org.pipelineframework.blocks", "graphql-agent", "jar"),
    ("org.pipelineframework.blocks", "openapi-representation-mapper", "jar"),
]
...
for event, candidate_type, number in [("pull_request", "pr", "42"), ("push", "main", "")]:
    ...
    with tempfile.TemporaryDirectory(prefix="tpf-candidate-metadata-") as temp:
        ...
        for group, artifact, packaging in COORDS:
            ...
            if artifact == "document-text-extraction":
                pom = (f'<project xmlns="{ns}"><modelVersion>4.0.0</modelVersion><parent>'
                       f'<groupId>org.pipelineframework</groupId><artifactId>pipeline-blocks</artifactId>'
        ...
        env = os.environ | {
            "GITHUB_REPOSITORY": "The-Pipeline-Framework/pipelineframework-blocks",
            "SOURCE_REPOSITORY": "Contributor/pipelineframework-blocks" if number else "The-Pipeline-Framework/pipelineframework-blocks",
            "SOURCE_SHA": sha,
        ...
        assert len(metadata["mavenArtifacts"]) == 5
        ...
        assert event_doc["source_repository"] == "The-Pipeline-Framework/pipelineframework-blocks"
        if number:
        ...
        validate_env = env | {
            ...
            "BUILD_RUN_REPOSITORY": "The-Pipeline-Framework/pipelineframework-blocks",
