...
Owner-local verification is the first gate. `.github/tpf-system-tests.json` owns the stable Blocks suite command.
`TPF Candidate Build` and the trusted publisher create an immutable, commit-specific Blocks candidate;
